...
//TODO - rename to Regexp_Condition
...
export class Capture extends Abstract_Element_Condition {
...
export class In_set extends Abstract_Element_Condition {
	constructor (set) {
		super();
...
export class Not_in_set extends Abstract_Element_Condition {
	constructor (set) {
		super();
		Object.assign(this, { set });
	}
...
export class Sequence2 extends Abstract_Condition {
	...
	match_sequence(sequence) {
		...
		return new M.Sub_Sequence_Match(this, sub_result, sequence, 0, sub_result.length - 1);
	}
