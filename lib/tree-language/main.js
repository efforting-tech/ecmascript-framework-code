...
import { install_tree_processing } from  './tree-processing.js';
import { install_context_skeleton } from  './context-skeleton.js';

export function create_default_system() {
	const system = new System();

	install_context_skeleton(system);
	install_tree_processing(system);
