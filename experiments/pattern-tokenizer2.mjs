...
import { implement_tokenizer, Pass_Through_Token_Processor, Standard_Token_Processor } from 'efforting.tech-framework/parsing/basic-tokenizer/implementation.js';
...
const system = P.tokenization_system(null,
	...
	P.sub_tokenizer('capture',
		...
		P.on_token('LD_ARROW', P.enter().then( P.emit_token(TOKEN.CAPTURE) )),
