...
export function create_system(target_context={}, records_tree=new Dotted_Tree_Directory(), dispatch_tree=new Dotted_Tree_Directory(), symbol_tree=new Dotted_Tree_Directory()) {
