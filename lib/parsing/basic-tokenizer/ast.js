...
export class Call_Function_Emit_Value extends Abstract_Action {
	constructor(function_reference, token_processor=null) {
		super();
		Object.assign(this, { function_reference, token_processor });
	}
}
