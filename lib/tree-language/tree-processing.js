...
import { create_namespace, create_resolver, create_placeholder_patterns, create_records } from './helpers.js';
...
export function install_tree_processing(system) {
	...
	const pattern_to_capture = create_resolver(O.Generic_Resolver, efforting, 'GR.tree_language.pattern_to_capture');
	...
	create_placeholder_patterns(efforting, pattern_to_capture, `
