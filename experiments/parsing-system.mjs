...
export function enter(sub_parser) {
	return new AST.Enter(sub_parser);
}
...
export function sub_parser(name, ...rules) {
	return new AST.Sub_Parser(name, rules);
}

export function parsing_system(name, ...components) {
	return new AST.Parsing_System(name, components);
}
